    ...
    return (
        <>
            <button
                ...
                className={`fixed bottom-4 right-4 cursor-pointer ${start
            ...
            <div
                className={`absolute z-[999999] bottom-24 right-4 w-[320px] h-[240px] rounded-[20px] overflow-hidden ${!start ? "hidden" : ""
                    }`}
                width={640}
                height={480}
            >
